/** The renderer's path on durslel-web. The host is immaterial — the binding decides the target. */
const RENDERER_PATH = 'https://renderer.internal/api/render';

/**
 * Hands a job to the renderer.
 *
 * The renderer is durslel-web's container: manim needs a real filesystem and a subprocess, neither
